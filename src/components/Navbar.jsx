  ...
  return (
    <>
      <div className="bg-dark text-white text-center py-2">
        ...
        >
          English <i class="fas fa-chevron-down ms-2"></i>
        </a>
      </div>
      <nav className="navbar navbar-expand-lg bg-white py-3 border border-bottom-dark">
        <div className="container">
          ...
          <div
            ...
            id="navbarNav"
          >
            <ul className="navbar-nav fs-5 ms-lg-auto">
              ...
              <li className="nav-item">
                <NavLink className="nav-link active ms-lg-3" to="/contact">
                  Contact
                </NavLink>
              </li>
              <li className="nav-item">
                <NavLink className="nav-link active mx-lg-3" to="/about">
                  About
                </NavLink>
              </li>
              <li className="nav-item">
            ...
            >
              ...
              {storedUser ? (
                ...
                <NavLink to="/favourites" className="text-dark">
                  <i className="far fa-heart fs-5 mx-4"></i>
                </NavLink>
                {favItems && (
                  <div className="fav-badge position-absolute">
                    {favItems.length}
                  </div>
                )}
              </div>
                    ...
                    <ul className="user-info-details position-absolute py-2">
                      <li className="mb-2">
                        <NavLink to="/myaccount">
                          <i className="fas fa-user me-2"></i>Manage My Account
                        </NavLink>
                      </li>
                      <li className="mb-2">
                        <NavLink to="/orders">
