        ...
        <>
            ...
            <nav className="navbar navbar-expand-lg bg-white py-3 border border-bottom-dark">
                <div className="container">
                    <Link className="navbar-brand fw-bold fs-3" to="/" href="#">Exclusive</Link>
                    ...
                    <div className="collapse navbar-collapse justify-content-center" id="navbarNav">
                        <ul className="navbar-nav fs-5">
                            ...
                            <li className="nav-item">
                                <Link className="nav-link active ms-lg-3" to="/contact">Contact</Link>
                            </li>
                            <li className="nav-item">
                                <Link className="nav-link active mx-lg-3" to='/about'>About</Link>
                            </li>
                            <li className="nav-item">
                    ...
                    <div className="d-flex align-items-center" style={{ cursor: "pointer" }}>
                        ...
                        <Link to="/wishlist" className="text-dark"><i className="far fa-heart fs-5 mx-4"></i></Link>
                        {favourites && (
                            <div className="fav-badge position-absolute">{favourites.length}</div>
                        )}
                        </div>
                        <div className="cart position-relative">
                        <Link to="/cart" className="text-dark"><i className="fas fa-cart-plus fs-5"></i></Link>
                        {cart && (
                            <div className="cart-badge position-absolute">{cart.length}</div>
                        )}
                        </div>
                        {storedUser?(<div className="user-info position-relative">
                            ...
                            {menuVisible && (
                                ...
                                <li className="mb-2"><Link to="/myaccount"><i className="fas fa-user me-2" ></i>Manage My Account</Link></li>
                                ...
                                <li className="mb-2"><Link><svg className="me-2" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    My Reviews</Link></li>
                                <li className="mb-2"><Link to="/signup" onClick={handleLogout}><svg className="me-2" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
